...
let sayinString = "1999";
let sayiInt = parseInt(sayinString);
console.log(sayiInt);
...
function oyun(oyuncu, bilgisayar) {
  ...
  if (options.indexOf(oyuncu) != -1 && options.indexOf(bilgisayar) != -1) {
    console.log("Oyunda Devam");
  }
  if (oyuncu == "Taş" || oyuncu == "Kağıt" || oyuncu == "Makas") {
    console.log("oyuna devam");
  } else {
    return "oyuna uygun argüman gir.";
  }

  if (bilgisayar == "Taş" || bilgisayar == "Kağıt" || bilgisayar == "Makas") {
    console.log("oyuna devam");
  } else {
    return "oyuna uygun argüman gir.";
  }
...
while (cocukSayisi >= 1) {
  console.log(cocukSarkisi(cocukSayisi));
  cocukSayisi--;
}
...
function notHesapla(alinanpuan) {
  if (alinanpuan >= 90 && alinanpuan <= 100) {
    return 'A aldın';
  } else if (alinanpuan >= 80 && alinanpuan <= 89) {
    return 'B aldın';
  }

  else if (alinanpuan >= 70 && alinanpuan <= 79) {
    return 'C aldın';
  }

  else if (alinanpuan >= 60 && alinanpuan <= 69) {
    return 'D aldın';
  }
  else return "F aldın"
}
